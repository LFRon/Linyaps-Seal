...
class MyButton_RefreshApps extends StatefulWidget {
  ...
  @override
  State<MyButton_RefreshApps> createState() => _MyButton_RefreshAppsState();
}

class _MyButton_RefreshAppsState extends State<MyButton_RefreshApps> {
  @override
